...
impl EPS {
    ...
    pub fn set_config_para(&self, typ_stid: StID, id: u16, mut rx_len: usize, mut input: Vec<u8>) -> EpsResult<Vec<u8>> {
        let cmd: u8 = match_st_id(typ_stid);
    ...
    pub fn get_config_para(&self, typ_stid: StID, id:u16, mut rx_len: usize) -> EpsResult<Vec<u8>> {
        let cmd: u8 = match_st_id(typ_stid);
    ...
    pub fn set_ch_startup_ena_bf(&self, typ_stid: StID, input: u32) -> EpsResult<Vec<u8>> {
        let id = 0x6002;
        let rx_len = std::mem::size_of::<u32>();
        self.set_config_para(typ_stid, id, rx_len, input.to_le_bytes().to_vec())
    }
    ...
    pub fn set_ttc_wdg_timeout(&self, typ_stid: StID,input:u16) -> EpsResult<Vec<u8>> {
        let id = 0x4000;
        let rx_len = std::mem::size_of::<u16>();
        self.set_config_para(typ_stid, id, rx_len, input.to_le_bytes().to_vec())
    }
    ...
    pub fn set_ch_latchoff_delay18(&self, typ_stid: StID,input:u16) -> EpsResult<Vec<u8>> {
        let id = 0x4034;
        let rx_len = std::mem::size_of::<u16>();
        self.set_config_para(typ_stid, id, rx_len, input.to_le_bytes().to_vec())
    }
    ...
    pub fn set_ch_latchoff_delay30(&self, typ_stid: StID, input:u16) -> EpsResult<Vec<u8>> {
        let id = 0x4040;
        let rx_len = std::mem::size_of::<u16>();
        self.set_config_para(typ_stid, id, rx_len, input.to_le_bytes().to_vec())
    }
    ...
    pub fn get_lothr_bp1_heater(&self, typ_stid: StID) -> EpsResult<Vec<u8>> {
        let id = 0x3000;
        let rx_len = std::mem::size_of::<i16>();
        self.get_config_para(typ_stid, id, rx_len)
    }
    ...
    pub fn set_bp2_temp2_premul(&self, typ_stid: StID, input:i16) -> EpsResult<Vec<u8>> {
        let id = 0x301C;
        let rx_len = std::mem::size_of::<i16>();
        self.set_config_para(typ_stid, id, rx_len, input.to_le_bytes().to_vec())
    }
